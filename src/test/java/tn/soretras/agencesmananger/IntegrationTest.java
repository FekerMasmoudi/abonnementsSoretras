...
import tn.soretras.agencesmananger.AgencesdbApp;
import tn.soretras.agencesmananger.config.AsyncSyncConfiguration;
import tn.soretras.agencesmananger.config.EmbeddedMongo;
...
@SpringBootTest(classes = { AgencesdbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
