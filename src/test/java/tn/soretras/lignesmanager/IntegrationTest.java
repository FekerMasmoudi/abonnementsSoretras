...
import tn.soretras.lignesmanager.LignesdbApp;
import tn.soretras.lignesmanager.config.AsyncSyncConfiguration;
import tn.soretras.lignesmanager.config.EmbeddedMongo;
...
@SpringBootTest(classes = { LignesdbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
