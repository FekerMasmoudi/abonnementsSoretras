package tn.soretras.stationsmanager.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tn.soretras.stationsmanager.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tn.soretras.stationsmanager.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
