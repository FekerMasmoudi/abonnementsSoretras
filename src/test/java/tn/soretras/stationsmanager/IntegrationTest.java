...
import tn.soretras.stationsmanager.StationsdbApp;
import tn.soretras.stationsmanager.config.AsyncSyncConfiguration;
import tn.soretras.stationsmanager.config.EmbeddedMongo;
...
@SpringBootTest(classes = { StationsdbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
