...
import tn.soretras.centremanager.CentredbApp;
import tn.soretras.centremanager.config.AsyncSyncConfiguration;
import tn.soretras.centremanager.config.EmbeddedMongo;
...
@SpringBootTest(classes = { CentredbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
