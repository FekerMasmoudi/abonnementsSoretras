package tn.soretras.centremanager.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tn.soretras.centremanager.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tn.soretras.centremanager.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
