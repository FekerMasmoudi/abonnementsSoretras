...
import tn.soretras.clientsmanager.ClientsdbApp;
import tn.soretras.clientsmanager.config.AsyncSyncConfiguration;
import tn.soretras.clientsmanager.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ClientsdbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
