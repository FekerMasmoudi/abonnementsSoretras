...
import tn.soretras.itineraires.ItinerairesdbApp;
import tn.soretras.itineraires.config.AsyncSyncConfiguration;
import tn.soretras.itineraires.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ItinerairesdbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
