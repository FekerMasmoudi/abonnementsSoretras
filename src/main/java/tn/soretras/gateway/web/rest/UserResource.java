package tn.soretras.gateway.web.rest;
...
import tn.soretras.gateway.config.Constants;
import tn.soretras.gateway.domain.User;
import tn.soretras.gateway.repository.UserRepository;
import tn.soretras.gateway.security.AuthoritiesConstants;
import tn.soretras.gateway.service.MailService;
import tn.soretras.gateway.service.UserService;
import tn.soretras.gateway.service.dto.AdminUserDTO;
import tn.soretras.gateway.web.rest.errors.BadRequestAlertException;
import tn.soretras.gateway.web.rest.errors.EmailAlreadyUsedException;
import tn.soretras.gateway.web.rest.errors.LoginAlreadyUsedException;

/**
 * REST controller for managing users.
 * <p>
 * This class accesses the {@link tn.soretras.gateway.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
